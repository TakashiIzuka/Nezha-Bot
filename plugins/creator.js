...
let handler = async(m, { conn }) => {
	...
	await delay(100)
  return conn.sendMessage(m.chat, { text: `Halo ʜᴜᴍᴀɴ ʏɢ ᴋᴇᴋ ᴋᴏɴᴛᴏʟ @${await m.sender.split('@')[0]}, ɪᴛᴜ ɴᴏᴍᴏʀ ᴏᴡɴᴇʀ ɢᴡ ᴊᴀɴɢᴀɴ ᴅɪ sᴘᴀᴍ ᴋᴀʟᴏ ɢᴀᴋ ɢᴡ ʙᴀɴ ᴡᴀ ᴘᴜ`, mentions: [m.sender] }, { quoted: conn.p[id][0] })
  await delay(100)
